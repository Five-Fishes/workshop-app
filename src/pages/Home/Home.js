  ...
  return (
    ...
    <SafeAreaView style={{flex:1 }}>
      <View style={{flexDirection:"row", marginRight:10}}>
        ...
        <View style = {{ width: 180,backgroundColor:"white", borderRadius:8,marginTop:18,marginRight:1, padding:13,paddingTop:18}}>
        ...
        <View style={{ padding: 8, flexDirection:"column",margin:18,flex:1,borderRadius:3,backgroundColor:"white" }}>
            {/* <Text
              style={{
                fontSize: 18,
                marginBottom: 16,
            ...
            <Image
              style={styles.img}
              source={{
                uri: 'https://www.perkinselearning.org/sites/elearning.perkinsdev1.org/files/styles/interior_page_image__519x374_/public/Leaves_0.jpg?itok=KoZTXYhD',
              }}
            />
